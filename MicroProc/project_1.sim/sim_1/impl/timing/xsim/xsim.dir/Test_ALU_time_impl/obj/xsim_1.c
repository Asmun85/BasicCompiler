...
{
	iki_sensitize(dp, "xsim.dir/Test_ALU_time_impl/xsim.reloc");
}

void simulate(char *dp)
{
	iki_schedule_processes_at_time_zero(dp, "xsim.dir/Test_ALU_time_impl/xsim.reloc");
	// Initialize Verilog nets in mixed simulation, for the cases when the value at time 0 should be propagated from the mixed language Vhdl net

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1301072, dp + 1301832, 0, 7, 0, 7, 8, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1301112, dp + 1301944, 0, 7, 0, 7, 8, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1301152, dp + 1302224, 0, 2, 0, 2, 3, 1);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/Test_ALU_time_impl/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/Test_ALU_time_impl/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/Test_ALU_time_impl/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, 0, isimBridge_getWdbWriter(), 0, argc, argv);
