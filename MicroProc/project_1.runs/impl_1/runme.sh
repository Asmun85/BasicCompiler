...
HD_PWD='/home/kanane/Bureau/4A/ProjetSI/project_1/MicroProc/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log My_processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source My_processor.tcl -notrace
